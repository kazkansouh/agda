...
import Agda.Interaction.Highlighting.Precise (HighlightingInfo, InteractionOutputCallback, defaultHighlightingOutput)
...
data TCState =
    TCSt { stFreshThings       :: FreshThings
	 ...
	 , stLocalBuiltins     :: BuiltinThings PrimFun
         ...
         , stHighlightingOutput  :: InteractionOutputCallback
